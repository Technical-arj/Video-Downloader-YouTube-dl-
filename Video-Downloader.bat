...
:cho1
ECHO %ESC%[96mCREATING A BRIEF DOCUMENTATION OF THIS SCRIPT........%ESC%[0m
ECHO/
ECHO/
ECHO %ESC%[96mAS YOUR CHOICE IS (A), WE ARE CREATING THE README PORTION (ALERT!! MY WHOLE PROJECT WORK IS JUST FOR KNOWLEDGE PERPOSE.)%ESC%[0m
